...
class _$AnnouncementImpl implements _Announcement {
  ...
  @override
  String toString() {
    return 'Announcement(id: $id, name: $name, slug: $slug, description: $description, content: $content, image: $image, categories: $categories, tags: $tags, createdAt: $createdAt, updatedAt: $updatedAt, startDate: $startDate, endDate: $endDate, address: $address)';
  }
...
abstract class _Announcement implements Announcement {
  const factory _Announcement(
      ...
      required final String address}) = _$AnnouncementImpl;
